...
test('lobby page reuses an in-flight fetchTournament request for the same tournament', async () => {
  ...
  try {
    ...
    assert.equal(firstResult && firstResult.name, 'Fresh Lobby Tournament');
    assert.equal(secondResult && secondResult.name, 'Fresh Lobby Tournament');
